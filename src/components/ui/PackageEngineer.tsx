...
const PackageEngineer = () => {
  ...
  return (
    <div className={`py-10 pl-6 pr-30 mt-10 relative max-w-[600px] info_bg border-bec border-3 ${isPackageChoosen ? "border_is" : "border_not"}`}>
      ...
      <p className="text-base font-extralight text-center text-becwhite mb-4 py-2 border-1 border-becwhite px-3 max-w-[250px]">Залишилось 2</p>
