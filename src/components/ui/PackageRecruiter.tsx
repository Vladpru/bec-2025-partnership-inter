...
const PackageBasic = ({ onChoose, selectedPackageName }: PackageProps) => {
  ...
  return (
    ...
    >
      <h2
        className={`pl-5 text-3xl 440px:text-4xl 4xl:text-5xl font-bold text-becwhite mb-4 text-start ${awide.className} leading-[1.3]`}
      >
        {pack1.name}
      </h2>
      <ul className="mb-6">
      ...
      <div className={`text-start ${awide.className} leading-[1.3]`}>
        <div
          className="mt-0 440px:mt-32 inline-block text-center px-12 py-3 text-2xl 440px:text-3xl bg-[#5A5A58] text-[#CFCFCF] border-2 border-[#CFCFCF] shadow-[inset_-3px_1px_15px_rgba(0,0,0,0.5)]
